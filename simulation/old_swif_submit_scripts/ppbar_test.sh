...
# Simulation related
REACTION=ppbar
RUN_LIST=('51153-51157' '51433-51437')  # Either single run number: 30730, or run range like 30796-30901 
TRIGGER=100000
# test
TESTRUN_LIST=('50685' '51384')
TESTTRIGGER=500
...
BKG_LIST=('recon-2018_08-ver02' 'recon-2018_08-ver02')
ENV_LIST=('recon-2018_08-ver02_16.xml' 'recon-2018_08-ver02_16.xml')
ANAENV_LIST=('analysis-2018_01-ver14.xml' 'analysis-2018_01-ver14.xml')
RCDBQUERY_LIST=('@is_2018production and @status_approved and beam_current > 49' '@is_2018production and @status_approved and beam_current < 49') # Got from https://halldweb.jlab.org/wiki-private/index.php/GlueX_Phase-I_Dataset_Summary
ENV_PATH=/u/home/haoli/test/MCWrapper_DEV
...
for idx in `seq 0 1`;
do
	ENVIRONMENT_FILE=`printf "%s/%s" "$ENV_PATH" "${ENV_LIST[idx]}" `
	ANA_ENVIRONMENT_FILE=`printf "%s/%s" "$ENV_PATH" "${ANAENV_LIST[idx]}" `
